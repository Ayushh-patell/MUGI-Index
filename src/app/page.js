  ...
  return (
    ...
    <Image src={"/onepiece bg.png"} alt="onepiece" fill className=" object-cover brightness-[0.2]"/>
      ...
      <div className=" w-full grid lg:grid-cols-4 grid-cols-2 gap-4 relative pt-10">
        ...
        <button><a className=" pointer-events-none text-xl font-extrabold text-white hover:text-gray-300 hover:underline" href="https://jdskjsk.com">Log Overview</a></button>
      </div>
    </main>
  );
}
